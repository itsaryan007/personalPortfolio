        ...
        5932: function(e, t, r) {
            ...
            function B() {
                return (B = n._(function*(e) {
                    ...
                    let {
                        pathname: r
                    } = (0, b.parsePath)(e.asPath), n = (0, O.hasBasePath)(r) ? (0, S.removeBasePath)(r) : r, o = (0, j.addBasePath)((0, P.addLocale)(n, e.locale));
                ...
                change(e, t, r, a, i) {
                    ...
                    return n._(function*() {
                        ...
                        if (!q && f.onlyAHashChange(ee) && !et) {
                            G.asPath = ee, J.events.emit("hashChangeStart", r, Z), f.changeState(e, t, r, o._({}, a, {
                                scroll: !1
                            })), Q && f.scrollToHash(ee);
                            try {
                    ...
                    return n._(function*() {
                        ...
                        try {
                            ...
                            if ((null == R ? void 0 : null == (j = R.effect) ? void 0 : j.type) === "rewrite") {
                                ...
                                if ((!g || n.includes(t)) && (e = t, r = R.effect.resolvedHref, a = o._({}, a, R.effect.parsedAs.query), u = (0, S.removeBasePath)((0, d.normalizeLocalePath)(R.effect.parsedAs.pathname, b.locales).pathname), s = b.components[e], c.shallow && s && b.route === e && !p)) return o._({}, s, {
                                    route: e
                                })
                            }
                            if ((0, E.isAPIRoute)(e)) return Y({
                                url: i,
                                router: b
                            }), new Promise(() => {});
                ...
                prefetch(e) {
                    ...
                    return n._(function*() {
                        ...
                        let n = (0, g.parseRelativeUrl)(e),
                            ...
                            s = u,
                            f = yield a.pageLoader.getPageList(), d = t, p = void 0 !== r.locale ? r.locale || void 0 : a.locale, h = yield D({
                                asPath: t,
                                locale: p,
                                router: a
                            });
